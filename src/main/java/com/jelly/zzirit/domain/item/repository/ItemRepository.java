...
public interface ItemRepository extends JpaRepository<Item, Long> {
    ...
    // 1. 이름으로 검색
    @Query("""
        SELECT new com.jelly.zzirit.domain.admin.dto.response.AdminItemFetchResponse(
    ...
    """)
    Page<AdminItemFetchResponse> searchItemsByName(@Param("name") String name, Pageable pageable);
    ...
    @Query("""
        ...
        WHERE i.id = :itemId
    """)
    Page<AdminItemFetchResponse> searchItemById(@Param("itemId") Long itemId, Pageable pageable);
    ...
    @Query("""
        ...
        JOIN ItemStock s ON s.item = i
    """)
    Page<AdminItemFetchResponse> findAllItems(Pageable pageable);
