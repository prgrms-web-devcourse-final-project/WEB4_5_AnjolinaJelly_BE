...
public class QueryAdminServiceTest {
    ...
    @InjectMocks
    private QueryAdminService queryAdminItemService;
    ...
    void 관리자_상품_조회_상품ID로_조회하면_단일_결과를_Page로_반환한다() {
        ...
        // when
        PageResponse<AdminItemFetchResponse> response = queryAdminItemService.getItems(null, itemId, pageable);
    ...
    void 관리자_상품_조회_이름으로_조회하면_조건에_맞는_상품들을_반환한다() {
        ...
        // when
        PageResponse<AdminItemFetchResponse> response = queryAdminItemService.getItems(name, null, pageable);
    ...
    void 관리자_상품_조회_필터가_없으면_전체목록을_조회한다() {
        ...
        // when
        PageResponse<AdminItemFetchResponse> response = queryAdminItemService.getItems(null, null, pageable);
